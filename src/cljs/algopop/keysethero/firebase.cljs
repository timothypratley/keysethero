(ns algopop.keysethero.firebase
  (:require
    [cljsjs.firebase]
...
(defn init []
  (js/firebase.initializeApp
    #js {:apiKey "AIzaSyCfWhE7p073v_HoFARcqkJIVpA4Z8vMixA"
         :authDomain "keysethero.firebaseapp.com"
         :databaseURL "https://keysethero.firebaseio.com"
         :storageBucket "keysethero.appspot.com"})
  (on-auth))
